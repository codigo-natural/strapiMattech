  ...
  forgotPassword: async (ctx) => {
    ...
    try {
      ...
      let info = await transporter.sendMail({
        ...
        html: `<h1>Password Reset</h1><p>Hello ${
          user.username
        },</p><p>You have requested to reset your password. Click the following link to reset your password: <a href="${"http://localhost:3000"}/reset-password?token=${resetToken}">${YOUR_NEXTJS_APP_URL}/reset-password?token=${resetToken}</a></p>`,
      });
